package cn.structured.datascope.example.mybatisplus.config;
...
public class MockDataScopeProvider implements DataScopeProvider {
    ...
    static {
        ...
        // 跨组织用户 - 组织10的部门1
        DataScopeInfo crossOrgInfo = new DataScopeInfo();
        crossOrgInfo.setUserId("user-row-cross-org");
        crossOrgInfo.setRoles(Arrays.asList("EMPLOYEE"));
        crossOrgInfo.setOrgId("10");
        crossOrgInfo.setDeptIds(Arrays.asList("1", "2"));
        USER_INFO_MAP.put("user-row-cross-org", crossOrgInfo);
        ...
        // 拥有查看手机权限的用户
        DataScopeInfo viewPhonePermInfo = new DataScopeInfo();
        viewPhonePermInfo.setUserId("user-perm-view-phone");
        viewPhonePermInfo.setRoles(Arrays.asList("EMPLOYEE"));
        viewPhonePermInfo.setPermissions(Arrays.asList("order:view_phone"));
        viewPhonePermInfo.setOrgId("10");
        viewPhonePermInfo.setDeptIds(Arrays.asList("1", "2", "3"));
        USER_INFO_MAP.put("user-perm-view-phone", viewPhonePermInfo);
