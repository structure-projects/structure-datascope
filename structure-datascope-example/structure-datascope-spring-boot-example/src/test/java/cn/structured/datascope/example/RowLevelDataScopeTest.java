...
class RowLevelDataScopeTest {
    ...
    class RowConditionApiTest {
        ...
        void org10Admin_GetRowCondition() throws Exception {
            ...
            // 验证包含组织10和部门过滤条件
            assertTrue(content.contains("org_id") || content.contains("dept_id"),
                    "Row condition should contain org_id or dept_id");
        }
        ...
        void dept1User_GetRowCondition() throws Exception {
            ...
            // 验证包含部门过滤条件
            assertTrue(content.contains("dept_id"), "Row condition should contain dept_id");
        }
